...
const legendItems = [
  { color: "bg-blue-200", label: "Đã uống thuốc" },
...
function generateColorCode(month) {
  const colorCode = {}
  if (month === 5) {
    for (let d = 1; d <= 9; d++) colorCode[String(d)] = "bg-blue-200"
...
export default function OvulationCalendar() {
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow max-w-4xl mx-auto">
      <h2 className="text-xl font-semibold mb-6 text-center">Lịch uống thuốc</h2>
