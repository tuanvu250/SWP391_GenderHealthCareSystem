...
export const getMockDataForRole = (role) => {
  const mockData = {
    ...
    Consultant: {
      ...
      recentQuestions: [
        {
          question: "Làm thế nào để ngăn ngừa các bệnh lây truyền qua đường tình dục?",
          userName: "user123",
          time: "2 giờ trước",
          category: "STIs",
        ...
        {
          question: "Tôi nên làm xét nghiệm STIs như thế nào và bao lâu một lần?",
        ...
        {
          question: "Tôi đang lo lắng về một số triệu chứng, liệu có thể là STIs không?",
    ...
    Staff: {
      ...
      todayTasks: [
        { task: "Chuẩn bị phòng xét nghiệm", description: "Chuẩn bị vật tư y tế", completed: true },
        { task: "Nhập kết quả xét nghiệm", description: "Cập nhật 5 kết quả vào hệ thống", completed: false },
        { task: "Xác nhận lịch hẹn", description: "Gọi điện xác nhận lịch hẹn ngày mai", completed: false },
        { task: "Kiểm kê vật tư", description: "Kiểm kê vật tư y tế cuối ngày", completed: false },
      ],
      taskCompletion: 25,
    ...
    Manager: {
      ...
      usersAndAppointments: [
        { date: '01/07', users: 120, testAppointments: 20, consultAppointments: 23 },
        { date: '02/07', users: 132, testAppointments: 25, consultAppointments: 26 },
        { date: '03/07', users: 101, testAppointments: 15, consultAppointments: 18 },
        { date: '04/07', users: 134, testAppointments: 22, consultAppointments: 24 },
        { date: '05/07', users: 90, testAppointments: 10, consultAppointments: 12 },
        { date: '06/07', users: 110, testAppointments: 18, consultAppointments: 20 },
        { date: '07/07', users: 140, testAppointments: 25, consultAppointments: 28 },
      ],
      pendingContent: [
        { title: 'Tìm hiểu về HPV và phòng ngừa', author: 'BS. Nguyễn A', submitted: '23/07/2024' },
        { title: 'Phòng ngừa STIs hiệu quả', author: 'BS. Trần B', submitted: '22/07/2024' },
        { title: 'Sức khỏe giới tính và các lưu ý', author: 'BS. Lê C', submitted: '21/07/2024' },
        { title: 'Xét nghiệm STIs định kỳ', author: 'BS. Phạm D', submitted: '20/07/2024' },
      ],
    },
    ...
    Admin: {
      ...
      apiUsage: [
        ...
        { endpoint: '/api/appointments', calls: 2840, responseTime: 180, errors: 2 },
        { endpoint: '/api/auth/login', calls: 1950, responseTime: 90, errors: 5 },
        { endpoint: '/api/tests', calls: 1680, responseTime: 320, errors: 0 },
        { endpoint: '/api/consultations', calls: 1420, responseTime: 275, errors: 1 },
      ...
      maintenanceTasks: [
        { name: 'Sao lưu dữ liệu tự động', status: 'completed', lastRun: '23/07/2024 01:00', nextRun: '24/07/2024 01:00' },
        { name: 'Tối ưu hóa cơ sở dữ liệu', status: 'pending', lastRun: '18/07/2024 03:00', nextRun: '25/07/2024 03:00' },
        { name: 'Quét virus & malware', status: 'completed', lastRun: '22/07/2024 02:00', nextRun: '29/07/2024 02:00' },
        { name: 'Xóa file tạm thời', status: 'processing', lastRun: '20/07/2024 04:00', nextRun: '27/07/2024 04:00' }
      ],
      ...
      recentActivities: [
        { type: 'success', message: 'Backup hệ thống hoàn tất', time: '10:30', user: 'System' },
        { type: 'warning', message: 'Phát hiện nhiều lần đăng nhập thất bại', time: '09:15', user: 'Security Monitor' },
        { type: 'normal', message: 'Cập nhật phiên bản phần mềm 2.3.1', time: '08:45', user: 'System' },
        { type: 'error', message: 'Lỗi kết nối đến máy chủ email', time: 'Hôm qua', user: 'Mail Server' }
      ]
    }
  };
