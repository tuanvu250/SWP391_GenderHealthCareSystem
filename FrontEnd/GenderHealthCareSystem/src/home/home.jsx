        ...
        <div className="mx-auto pt-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 pb-0">
            ...
            <div className="w-full lg:w-1/2 space-y-6 lg:pb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight">
                ...
                <span className="block text-[#0099CF]">
                  với Gender Healthcare
                </span>
              </h1>

              <p className="text-lg text-gray-600 mt-4 max-w-lg">
                Kết nối với các chuyên gia hàng đầu, khám phá dịch vụ chăm sóc
                cá nhân hóa và trải nghiệm cuộc sống khỏe mạnh hơn chỉ với vài
                cú nhấp chuột.
              </p>
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              {/* Floating tags */}
              <div className="absolute top-20 right-15 md:top-20 md:right-30 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                <p className="md:text-sm font-medium text-gray-700 text-sm/2">
                  Sức khỏe tốt hơn
                </p>
              </div>
              ...
              <div className="absolute bottom-20 left-5 md:bottom-36 md:left-0 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg z-40">
                <p className="md:text-sm text-sm/2 font-medium text-gray-700">
        ...
        <div className="mx-auto relative z-10">
          <div className="text-center mb-16 relative">
            ...
            <p className="text-gray-600 max-w-xl mx-auto mt-6">
              Các dịch vụ được thiết kế đặc biệt để đáp ứng nhu cầu sức khỏe của
              bạn với sự chăm sóc chuyên nghiệp và tiện lợi.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 relative group">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-8">
                  Theo dõi chu kì kinh nguyệt của bạn, nhận nhắc nhở thời gian
                  rụng trứng, khả năng mang thai, và thời gian uống thuốc tránh
                  thai.
                </p>
                <Button
                  type="primary"
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 relative group">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-8">
                  Đặt lịch trực tuyến với tư vấn viên để trao đổi những thắc mắc
                  của bạn về sức khỏe một cách riêng tư và an toàn.
                </p>
                <Button
                  type="primary"
                  className="rounded-full px-6 flex items-center gap-2 hover:translate-x-1 transition-transform"
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 relative group">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-8">
                  Đặt lịch xét nghiệm STIs và nhận kết quả online một cách nhanh
                  chóng, bảo mật và chính xác.
                </p>
                <Button
                  type="primary"
                  className="rounded-full px-6 flex items-center gap-2 hover:translate-x-1 transition-transform"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Đội ngũ tư vấn viên và bác sĩ được đào tạo chuyên sâu về sức
                khỏe giới tính.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Cam kết bảo mật thông tin cá nhân và tạo môi trường an toàn cho
                người dùng.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Theo dõi sức khỏe và truy cập thông tin bất kỳ lúc nào, nơi nào
                bạn muốn.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Kết quả xét nghiệm chính xác với độ tin cậy cao từ các phòng lab
                được chứng nhận.
              </p>
            </div>
          </div>
