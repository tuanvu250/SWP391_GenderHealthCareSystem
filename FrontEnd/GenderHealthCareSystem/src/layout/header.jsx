...
import { CaretDownFilled, BellOutlined, UserOutlined } from "@ant-design/icons";
...
const Header = () => {
  ...
  return (
    <header className="bg-white z-50 px-0.5 text-gray-800 py-3 shadow-sm sticky top-0 border-b border-gray-100">
      <div className="container mx-auto flex justify-between items-center px-4">
            ...
            <li className="hover:text-[#0099CF] cursor-pointer transition-colors border-b-2 border-transparent hover:border-[#0099CF] py-2">
                ...
                overlay={
                  <Menu>
                    <Menu.Item
                      key="1"
                      onClick={() =>
                        handleNavigation("/services/health-checkup")
                      }
                    >
                      Xét nghiệm STis
                    </Menu.Item>
              ...
              >
                <a className="flex items-center space-x-1">
                  <span>Dịch vụ</span>
                  <CaretDownFilled className="text-gray-500 size-2.5" />
                </a>
              </Dropdown>
            </li>
            <li className="hover:text-[#0099CF] cursor-pointer transition-colors border-b-2 border-transparent hover:border-[#0099CF] py-2">
        ...
        <div className="flex items-center space-x-3">
          ...
          {isLoggedIn ? (
            <div className="flex items-center space-x-10 gap-6">
              <Badge count={5}>
