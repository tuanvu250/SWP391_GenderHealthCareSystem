...
export default function Consultation() {
    ...
    return (
        <div className="bg-gradient-to-r from-sky-50 to-blue-100 overflow-hidden md:px-16 px-4">
            ...
            <div className="bg-gray-50 py-12 px-6 mb-20">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 text-center mb-2">
                        Người dùng đã trải nghiệm và đánh giá
                    </h2>
                    <p className="text-center text-gray-500 mb-8 text-sm">
                        Người dùng nghĩ gì sau khi tư vấn sức khỏe giới tính tại Gender Healthcare
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                            <div className="flex items-center mb-2">
                                ...
                                <div>
                                    <p className="font-medium text-gray-700">Nguyễn T. L.</p>
                                    <p className="text-xs text-gray-400">04/06/2025</p>
                                </div>
                            </div>
                            <p className="text-yellow-600 mb-2">🥰 Rất hài lòng</p>
                            <p className="text-gray-700 text-sm">
                                Bác sĩ tư vấn rất tâm lý và không phán xét khi mình chia sẻ về xu hướng tính dục. Mình cảm thấy được lắng nghe thật sự!
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                            <div className="flex items-center mb-2">
                                <div className="w-10 h-10 bg-gray-200 rounded-full mr-3" />
                                <div>
                                    <p className="font-medium text-gray-700">A. Minh</p>
                                    <p className="text-xs text-gray-400">27/05/2025</p>
                                </div>
                            </div>
                            <p className="text-yellow-600 mb-2">🤗 Rất hài lòng</p>
                            <p className="text-gray-700 text-sm">
                                Tư vấn qua Gender Healthcare giúp mình an tâm về sức khỏe. Cảm ơn tư vấn viên nhiều ạ.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                            <div className="flex items-center mb-2">
                                <div className="w-10 h-10 bg-gray-200 rounded-full mr-3" />
                                <div>
                                    <p className="font-medium text-gray-700">Ẩn danh</p>
                                    <p className="text-xs text-gray-400">15/05/2025</p>
                                </div>
                            </div>
                            <p className="text-yellow-600 mb-2">😊 Vô cùng hài lòng</p>
                            <p className="text-gray-700 text-sm">
                                Lần đầu tiên tư vấn online nhưng bác sĩ tư vấn nhẹ nhàng, dễ hiểu và không ngại trả lời câu hỏi “tế nhị”.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                            <div className="flex items-center mb-2">
                                <div className="w-10 h-10 bg-gray-200 rounded-full mr-3" />
                                <div>
                                    <p className="font-medium text-gray-700">Lê Thảo</p>
                                    <p className="text-xs text-gray-400">08/05/2025</p>
                                </div>
                            </div>
                            <p className="text-yellow-600 mb-2">❤️ Rất hài lòng</p>
                            <p className="text-gray-700 text-sm">
                                 Gender Healthcare thật sự khiến mình yên tâm. Cảm ơn sự tận tình của tư vấn viên ạ.
                            </p>
                        </div>
                    </div>
                </div>
