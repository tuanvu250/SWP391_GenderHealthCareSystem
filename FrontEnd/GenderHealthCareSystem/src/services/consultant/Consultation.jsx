...
export default function Consultation() {
  ...
  const handleBooking = () => {
    if (!isLoggedIn) {
      ...
      navigate("/services/consultationbooking");
    }
  };
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative z-10 bg-white rounded-2xl p-8 shadow-xl">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">Từ đặt lịch đến buổi tư vấn</p>
              </div>
              ...
              <ol className="space-y-4 text-left">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Chọn tư vấn viên</p>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Điền thông tin</p>
                    <p className="text-gray-500">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Chờ xác nhận</p>
                    <p className="text-gray-500">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Tham gia tư vấn</p>
                    <p className="text-gray-500">
