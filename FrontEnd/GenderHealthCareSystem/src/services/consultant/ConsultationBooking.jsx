                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex gap-6">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="consultationType" value="online" required defaultChecked className="accent-[#0099CF]" />
                        <span>Tư vấn Online</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="consultationType" value="direct" className="accent-[#0099CF]" />
        ...
        {successModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
              <div className="bg-white p-6 rounded-xl shadow-xl">
                ...
                <p className="text-gray-700">Chúng tôi sẽ liên hệ xác nhận với bạn sớm nhất.</p>
                <button
                    className="mt-4 bg-[#0099CF] text-white px-5 py-2 rounded-lg hover:bg-[#0077aa]"
