  ...
  return (
    <Layout className="min-h-screen">
      <Layout.Content className="bg-gray-50">
        {/* Banner theo dõi thuốc với tone xanh lá */}
        <div className="bg-gradient-to-r from-green-50 to-green-100 py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between">
              ...
              <div className="w-full lg:w-1/2 pr-0 lg:pr-8 mb-4 lg:mb-0">
                ...
                <Title level={3} className="mb-2">
                  ...
                  <span className="text-green-500">đúng giờ & đúng liều</span>
                </Title>
              ...
              <div className="w-full lg:w-5/12 rounded-xl p-4">
                <div className="mb-3">
                  <div className="items-center justify-center bg-green-100 mb-2">
